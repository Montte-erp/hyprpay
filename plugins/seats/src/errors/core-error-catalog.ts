...
export const billingErrors = defineErrorCatalog("hyprpay.seats", {
  INVALID_INPUT: {
    status: 400,
    message: "Dados de billing inválidos.",
    tags: ["hyprpay", "billing", "seats"],
  },
  NOT_FOUND: {
    status: 404,
  ...
  PROVIDER_REQUEST_FAILED: {
    ...
    tags: ["hyprpay", "billing", "provider", "seats"],
  },
  ...
  DATABASE_REQUEST_FAILED: {
    ...
    tags: ["hyprpay", "billing", "database", "seats"],
  },
  ...
  INVALID_WEBHOOK_SIGNATURE: {
    ...
    tags: ["hyprpay", "billing", "webhook", "seats"],
  },
});

declare module "evlog" {
  interface RegisteredErrorCatalogs {
    "hyprpay.seats": typeof billingErrors;
  }
}
