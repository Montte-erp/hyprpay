...
export const billingErrors = defineErrorCatalog("hyprpay.catalog", {
  INVALID_INPUT: {
    status: 400,
    message: "Dados de billing inválidos.",
    tags: ["hyprpay", "billing", "catalog"],
  },
  NOT_FOUND: {
    status: 404,
  ...
  PROVIDER_REQUEST_FAILED: {
    ...
    tags: ["hyprpay", "billing", "provider", "catalog"],
  },
  ...
  DATABASE_REQUEST_FAILED: {
    ...
    tags: ["hyprpay", "billing", "database", "catalog"],
  },
  ...
  INVALID_WEBHOOK_SIGNATURE: {
    ...
    tags: ["hyprpay", "billing", "webhook", "catalog"],
  },
});

declare module "evlog" {
  interface RegisteredErrorCatalogs {
    "hyprpay.catalog": typeof billingErrors;
  }
}
